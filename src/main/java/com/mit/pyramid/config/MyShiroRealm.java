...
import com.mit.pyramid.service.impl.BPermissionServiceImpl;
...
public class MyShiroRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		...
		BUser userInfo  = (BUser) principals.getPrimaryPrincipal();
...
//		authorizationInfo.addStringPermission("userInfo:query");
		...
		authorizationInfo.addRole(roleid.toString());
		authorizationInfo.setRoles(new HashSet<>(new BPermissionServiceImpl().rolePermisssions(roleid)));
